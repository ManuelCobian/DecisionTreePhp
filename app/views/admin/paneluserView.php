						 	...
						 	<tr>
								...
								<td>
						 		...
						 		<center>
						 				...
						 				?>
						 				<center>
						 				<a   href="<?php echo BASE_URL.'?controller=public&action=Edit_campaing&id='.$data->id.'' ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detalis of User"><i class="fa fa-pencil"></i> Edit</a>
						 				</center>

						 				<?php }else{ ?>

						 				<center>
						 				<a  href="<?php echo BASE_URL.'?controller=public&action=Show_Campaing&id='.$data->id .'' ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detalis of Campain"><i class="fa fa-eye"></i> Details</a>
						 				...
						 				if ($data->enabled>=1 and $data->authorized>=1) {
						 				# code...
						 				...
						 				<button  id="<?php echo $data->id ?>"  class="btn btn-danger desable" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detalis of User"><i class="fa fa-close"></i>Desable</button>

						 				<?php } ?>

						 					
						 				
						 				<?php if ($data->enabled<=0 and $data->authorized>=1) {
						 				# code...
						 					$enable="No";
						 					$auto="Yes";
						 				 ?>

						 				<button  id="<?php echo $data->id ?>"  class="btn btn-danger enable" data-toggle="tooltip" data-placement="top" title="" data-original-title="Detalis of User"><i class="fa fa-check"></i>Enabled</button>
						 		...
						 		<td><?php echo "<center>".$auto."<center>"; ?></td>
